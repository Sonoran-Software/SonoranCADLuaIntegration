...
class TeamSpeak extends events_1.EventEmitter {
    ...
    async sendChannelMessage(target, msg) {
        ...
        orders.push(this.sendTextMessage(target, enum_1.TextMessageTargetMode.CHANNEL, msg));
        if (sourceChannel !== cid)
            orders.push(self.move(sourceChannel));
    ...
    async uploadIcon(data) {
        const id = buffer_crc32_1.default.unsigned(data);
...
})(TeamSpeak || (exports.TeamSpeak = TeamSpeak = {}));
